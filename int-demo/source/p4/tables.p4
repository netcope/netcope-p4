...
action int_set_header_1() { //port_ids
    ...
    modify_field(int_port_ids_0.ingress_port_id,intrinsic_metadata.ingress_port);
    modify_field(int_port_ids_0.egress_port_id,intrinsic_metadata.egress_port);
}
...
action send_to_cpu() {
     modify_field(intrinsic_metadata.egress_port,CPU_PORT);
}

action send_to_eth() {
     modify_field(intrinsic_metadata.egress_port,ETH_PORT);
}
